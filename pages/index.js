  ...
  return (
    <div className={styles.container}>
      <main className={styles.main}>
        <h1 className={styles.title}>Welcome to $EDOGE LP Farming</h1>

        <p className={styles.description}>
          Add liquidity to EXP/EDOGE on EggSwap, stake your LP tokens here to earn $EDOGE!
          <br>
        </br>
        LP Token Address - 0x53938AE33281DF7ACc6558915f269e4F9Bf6a9E1
        <br></br>
